    ...
    return (
        <>
            <nav className="shadow-md flex flex-col md:flex-row justify-between items-center px-3 py-4 rounded-b-2xl fixed top-0 right-0 left-0 backdrop:blur-md z-50">
                <h1 className="text-2xl font-bold mb-2 text-black">BlogNest</h1>
                <div className="flex justify-center items-center gap-2">
                    ...
                    className=" outline-none border-b-2 border-black text-black focus:border-white bg-transparent transition-all px-2 py-1 md:w-[20vw]"
                    />         
                </div>
            </nav>
        </>
