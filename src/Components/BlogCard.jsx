...
const BlogCard = () => {
  return (
    <Link to={`/blog/${1234}`} className="relative flex flex-col md:flex-row py-2 gap-3 justify-start items-center md:px-5 rounded-3xl shadow-md bg-white w-full h-fit">
      <img src={coinwave} alt="thumbnail" className="md:w-[20vw] rounded-2xl md:rounded-3xl" />
